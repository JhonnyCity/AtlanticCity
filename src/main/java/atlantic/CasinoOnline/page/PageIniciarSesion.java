...
import atlantic.CasinoOnline.xpath.XpathIniciarSesion;
...
public class PageIniciarSesion extends PageObject {
    ...
    public void seleccionarCookies(){
        pageObjectUtil.seleniumClick(xpathIniciarSesion.Xpath_btnCookies, 0);
    }
    ...
    public void seleccionarCasinoOnline(){
        pageObjectUtil.seleniumClick(xpathIniciarSesion.Xpath_btnIrACasino, 0);
    }
    public void seleccionarVertical(String dato) {
        utilDef.esperarSegundos(4);
        pageObjectUtil.seleniumClick(xpathIniciarSesion.retornarXpathParametroVertical(dato), 0);
    }
    public void ingresarDatosInicioSesion(String usuario, String password){
        pageObjectUtil.seleniumEscribir(xpathIniciarSesion.Xpath_txtUsuario, usuario);
        pageObjectUtil.seleniumEscribir(xpathIniciarSesion.Xpath_txtPassword, password);
    }

    public void seleccionarIngresar(){
        pageObjectUtil.seleniumClick(xpathIniciarSesion.Xpath_btnIngresar, 0);
